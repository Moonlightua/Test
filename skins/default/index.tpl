...
<header>
	...
	<div class="head-text" id="menu">
		...
		<a href="/index.php?module=Actions&page=MsgsAll">messages</a>
		<a href="/index.php?module=Actions&page=Registration">contacts</a>
		<a href="/index.php?module=Actions&page=EmailsSubs">emails</a>
	</div>
</header>
<div id="content">
